...
namespace Microsoft.WindowsAPICodePack.Controls.WindowsForms
{
  ...
  return (int)(((ushort)lowPart) | (uint)(highPart << 16));
      ...
      SubclassHWND ShellViewExplorerManager;
    public void SetUpShellViewHandles(bool isHandle = true)
    {
      Invoke(new MethodInvoker(
        delegate
        {
          ...
          if (isHandle)
          {
              ...
              ShellViewExplorerManager = new SubclassHWND(this, SysListViewHandle);
              ShellViewExplorerManager.AssignHandle(ShellSysListViewHandle);
              //SubclassHWND s = new SubclassHWND(this, SysListViewHandle);
              //s.AssignHandle(ShellSysListViewHandle);
    ...
    internal void FireContentEnumerationComplete()
        {
          ...
          try
          {
            try
            {
                ShellViewExplorerManager.ReleaseHandle(); //DeSubClass(ShellSysListViewHandle);
            }
            catch (Exception)
            {
